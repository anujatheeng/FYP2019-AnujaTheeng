...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
       ...
       // GIDSignIn.sharedInstance().clientID = "386936148066-r2jpe3br1kod776f6dbpjb100bpr4d8j.apps.googleusercontent.com"
...
//        let rootVC = mainScreenVC.instantiateViewController(identifier: "initialController")
//        self.window?.rootViewController = rootVC
//        self.window?.makeKeyAndVisible()
//
//
//    }
    ...
    func showMainView(){
        ...
        let settingNav = UINavigationController(rootViewController: settingController)
        
        let tabbar = UITabBarController()
        tabbar.viewControllers = [homeNav,profileNav,settingNav]
...
//    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MyProjectApp")
