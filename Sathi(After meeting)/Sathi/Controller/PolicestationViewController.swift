...
class PolicestationViewController: UIViewController, MKMapViewDelegate { // displaying the type of map
    
    @IBAction func mapTypeChanged(_ sender: UISegmentedControl) {
        policestationView.mapType = MKMapType.init(rawValue: UInt(sender.selectedSegmentIndex)) ?? .standard
    }
